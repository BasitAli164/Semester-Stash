...
.data
   ...
   key_message db 'Wellcome to ZBS madical store Press enter to continue... $'
   password db 'coding$'
   incorrect_password db 10,13, 'Incorrect Password$'    
   welcome db 10,13,10,13, 'WELCOME TO ZBS Medical STORE$'
   ...
   opt2 db 10,13, '2. Paracetamol           - rs 3$'
   opt3 db 10,13, '3. Cleritek              - rs 2$'
   opt4 db 10,13, '4. Aspirin               - rs 2$'
   opt5 db 10,13, '5. Brufen                - rs 1$'
   opt6 db 10,13, '6. Surbex Z              - rs 5$'
   opt7 db 10,13, '7. Arinac                - rs 4$'
   opt8 db 10,13, '8. Sinopharm Vaccine     - rs 2$'
   opt9 db 10,13, '9. Pfizer Vaccine        - rs 8$'
   ...
   total_msg db 10,13, 'Total collected= $'
   ...
   ; amount-related msgs
   amount_earned db 10,13,'Amount collected= $'
   amount db 10,13, 0
   amount_print db 10,13,'Press 3 to show amount collected today$'
   panadol_sold db 10,13, dw        0
   paracetamol_sold db 10,13, dw    0
   cleritek_sold db 10,13, dw       0
   aspirin_sold db 10,13, dw        0
   brufen_sold db 10,13, dw         0
   surbex_sold db 10,13, dw         0
   arinac_sold db 10,13, dw         0
   sinopharm_sold db 10,13, dw      0
   pfizer_sold db 10,13,  dw        0
